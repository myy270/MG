...
#define	TEXTURE_TITLE_LOGO	"data/TEXTURE/title000.png"		// 読み込むテクスチャファイル名
...
#define	TITLE_LOGO_WIDTH		(640 * 1.5f * (SCREEN_WIDTH  / 1280.0f))		// タイトルロゴの幅
#define	TITLE_LOGO_HEIGHT		(640 * 1.0f * (SCREEN_HEIGHT /  720.0f))		// タイトルロゴの高さ
